...
namespace Repositorio
{
    public class RepositorioFuncionarios
    {
        ...
        {
            return Funcionarios.FindAll(funcionario => funcionario.Cargo.Equals(cargo)) as IList<Funcionario>;
        }

        public IList<Funcionario> OrdenadosPorCargo()
        {
            return
                Funcionarios.OrderBy(funcionario => funcionario.Cargo.Titulo).ThenBy(funcionario => funcionario.Nome).ToList();
        }
        ...
        public IList<Funcionario> BuscarPorNome(string nome)
        {
            ...
            return Funcionarios.FindAll(funcionario => funcionario.Nome.Equals(nome, StringComparison.CurrentCultureIgnoreCase)) as IList<Funcionario>;
        }        
